...
public class ListNotesAdapter extends RecyclerView.Adapter<ListNotesAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_list_notes, null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.tvItemListTitle.setText(mLists.get(i).getTitle());
        viewHolder.tvItemListDate.setText(Tools.getNormalDate(mLists.get(i).getDate()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvItemListTitle = itemView.findViewById(R.id.tvItemListNotesTitle);
            tvItemListDate = itemView.findViewById(R.id.tvItemListNotesDate);
